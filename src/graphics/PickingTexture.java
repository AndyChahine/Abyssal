...
public class PickingTexture {
	...
	public boolean init(int width, int height) {
		...
		// causing error when attaching framebuffer possibly a problem with resizing width and height
//		GL30.glEnable(GL30.GL_TEXTURE_2D);
//		depthTexture = GL30.glGenTextures();
//		GL30.glBindTexture(GL30.GL_TEXTURE_2D, depthTexture);
//		GL30.glTexImage2D(GL30.GL_TEXTURE_2D_ARRAY, 0, GL30.GL_DEPTH_COMPONENT, width, height, 0, GL30.GL_DEPTH_COMPONENT, GL30.GL_FLOAT, 0);
//		GL30.glFramebufferTexture2D(GL30.GL_FRAMEBUFFER, GL30.GL_DEPTH_ATTACHMENT, GL30.GL_TEXTURE_2D, depthTexture, 0);
